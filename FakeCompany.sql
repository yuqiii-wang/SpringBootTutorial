...
CREATE TABLE `product` (
  ...
  `Manufacture_Location` VARCHAR(10) NOT NULL,
  `Price` INT NOT NULL,
  `Cost` INT NOT NULL,
...
('CHOPS','Chop-suey Chinese','Yang Wang','Owner','Hauptstr. 29','Bern',NULL,'3012','Switzerland','0452-076545',NULL),('COMMI','Comércio Mineiro','Pedro Afonso','Sales Associate','Av. dos Lusíadas, 23','Sao Paulo','SP','05432-043','Brazil','(11) 555-7647',NULL),
...
('GALED','Galería del gastrónomo','Eduardo Saavedra','Marketing Manager','Rambla de Catalu?a, 23','Barcelona',NULL,'08022','Spain','(93) 203 4560','(93) 203 4561'),
...
('TOMSP','Toms Spezialit?ten','Karin Josephs','Marketing Manager','Luisenstr. 48','Münster',NULL,'44087','Germany','0251-031259','0251-035695'),
('TORTU','Tortuga Restaurante','Miguel Angel Paolino','Owner','Avda. Azteca 123','México D.F.',NULL,'05033','Mexico','(5) 555-2933',NULL),
('TRADH','Tradi??o Hipermercados','Anabela Domingues','Sales Representative','Av. Inês de Castro, 414','Sao Paulo','SP','05634-030','Brazil','(11) 555-2167','(11) 555-2168'),
